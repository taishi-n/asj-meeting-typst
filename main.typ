...
#link("https://acoustics.jp/annualmeeting/call-for-paper/call-for-paper_jp/")[公式の講演募集]では，講演発表者の`☆`は学生優秀発表賞と粟屋潔学術奨励賞の対象，`◎`は粟屋潔学術奨励賞のみの対象，`○`は両賞の対象外を示す．連名者の`△`は会員外，無印は会員を示す．記号と所属略称は`authors`へ直接記述する．
